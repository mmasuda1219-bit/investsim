...
- 影響ファイル: app/api/signals/[symbol]/route.ts, app/stocks/[symbol]/page.tsx, components/MasterSignals.tsx, lib/ai-trader/engine.ts, lib/simulation.ts, app/simulate/page.tsx, lib/market/index.ts, scripts/check-previous-close.ts, components/TradingChart.tsx（削除）, app/api/chart/route.ts（削除）, NEXT-STEPS.md, DESIGN.md
